function Registro (){
    return(
      ...
      <div class="auth-box">
        ...
        <p class="subtitle">Completa el formulario de validación institucional.</p>
        ...
        <form id="registerForm">
          <div class="fg">
            ...
            <span class="warning-txt" id="warn-reg-name">El nombre debe contener entre 3 y 40 caracteres alfabéticos.</span>
          </div>
          ...
          <div class="fg">
            ...
            <span class="warning-txt" id="warn-reg-user">Ingresa un formato de correo institucional válido.</span>
          </div>
          ...
          <div class="fg">
            ...
            <div class="input-wrapper">
              ...
              <button type="button" class="btn-eye" onclick="typeof togglePass === 'function' && togglePass('reg-pass')">👁️</button>
            </div>
            <div class="strength-meter">
              <div id="rs1" class="strength-seg"></div>
              <div id="rs2" class="strength-seg"></div>
              <div id="rs3" class="strength-seg"></div>
              <div id="rs4" class="strength-seg"></div>
            </div>
          </div>

          <button type="submit" class="btn-block">Crear Cuenta Principal</button>
        </form>
